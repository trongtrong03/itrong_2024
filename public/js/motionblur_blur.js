...
function whenDone(){
    ...
    // 手動複製
    var x = document.getElementsByClassName("blurjs2");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB2 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs2") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB2 = 1;
        }    
    }

    var x = document.getElementsByClassName("blurjs3");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB3 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs3") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB3 = 1;
        }    
    }

    var x = document.getElementsByClassName("blurjs4");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB4 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs4") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB4 = 1;
        }    
    }

    var x = document.getElementsByClassName("blurjs5");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB5 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs5") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB5 = 1;
        }    
    }

    var x = document.getElementsByClassName("blurjs6");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB6 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs6") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB6 = 1;
        }    
    }

    var x = document.getElementsByClassName("blurjs7");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptB7 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("blurjs7") >= 0){
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;' class=");
                    var justTemp_2 = y[r].outerHTML.replace(/class=/, "style='animation-delay:20ms;' class=");
                    var justTemp_3 = y[r].outerHTML.replace(/class=/, "style='animation-delay:40ms;' class=");
                    var justTemp_4 = y[r].outerHTML.replace(/class=/, "style='animation-delay:60ms;' class=");
            ...
            window.runScriptB7 = 1;
        }    
    }

    var x = document.getElementsByClassName("fadejs2");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptF2 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("fadejs2") >= 0){
                    let opacityValues = getTrueOpacity(y[r]);
                    let opacity = opacityValues[0];
                    let specialOpacity = opacityValues[1];
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;opacity:" + specialOpacity + ";' class=");
            ...
            window.runScriptF2 = 1;
        }
    }

    var x = document.getElementsByClassName("fadejs3");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptF3 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("fadejs3") >= 0){
                    let opacityValues = getTrueOpacity(y[r]);
                    let opacity = opacityValues[0];
                    let specialOpacity = opacityValues[1];
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;opacity:" + specialOpacity + ";' class=");
            ...
            window.runScriptF3 = 1;
        }
    }

    var x = document.getElementsByClassName("fadejs4");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptF4 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("fadejs4") >= 0){
                    let opacityValues = getTrueOpacity(y[r]);
                    let opacity = opacityValues[0];
                    let specialOpacity = opacityValues[1];
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;opacity:" + specialOpacity + ";' class=");
            ...
            window.runScriptF4 = 1;
        }
    }

    var x = document.getElementsByClassName("fadejs5");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptF5 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("fadejs5") >= 0){
                    let opacityValues = getTrueOpacity(y[r]);
                    let opacity = opacityValues[0];
                    let specialOpacity = opacityValues[1];
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;opacity:" + specialOpacity + ";' class=");
            ...
            window.runScriptF5 = 1;
        }
    }

    var x = document.getElementsByClassName("fadejs6");
    var i;
    for (i = 0; i < x.length; i++) {
        if(window.runScriptF6 !== 1){
            var y = x[i].parentNode.children;
            var r;
            for (r = 0; r < y.length; r++) {
                if(y[r].className.search("fadejs6") >= 0){
                    let opacityValues = getTrueOpacity(y[r]);
                    let opacity = opacityValues[0];
                    let specialOpacity = opacityValues[1];
                    var justTemp_1 = y[r].outerHTML.replace(/class=/, "style='animation-delay:0ms;opacity:" + specialOpacity + ";' class=");
