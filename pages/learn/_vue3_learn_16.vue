...
<div class="text-content">
    ...
    <div class="text-block" id="act0">
        <h2>序、前言</h2>
        <p>之前的文章有稍微介紹到路由之間的通信可以透過 <em>query</em> 或 <em>params</em> 來做到傳遞參數的功用，而組件之間若也想傳遞特定資料給另一個組件，則需要使用 <em>props</em> 語法，而組件之間也不是只有單純平輩與平輩而已，有可能是父與子、父與孫等多種情境的組件狀態，不同關聯下的 <em>props</em> 使用方式也有所區別，本篇文章主要便是要來學習如何在各種組件關係正確地使用 <em>props</em>。</p>
    </div>
