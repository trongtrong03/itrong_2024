<template>
    <NuxtLayout name="article">
        <TempArticle :propValue="21" fileType="learnList" />
<!-- start -->
<div class="text-content">
    <div class="text-catalog">
        <ul>
            <li><a href="#act0">序、前言</a></li>
            <li><a href="#act1">一、什麼是 Lottie？</a></li>
            <li><a href="#act2">二、下載檔案</a></li>
            <li><a href="#act3">三、開始安裝</a></li>
            <li><a href="#act4">四、使用方法</a></li>
            <li><a href="#act5">五、如何預覽</a></li>
            <li><a href="#act6">六、注意事項</a></li>
