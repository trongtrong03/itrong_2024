<template>
    <NuxtLayout name="article">
        <TempArticle :propValue="10" fileType="learnCSS" />
<!-- start -->
<div class="text-content">
    <div class="text-catalog">
        <ul>
            ...
            <li><a href="#act2">二、宣告變數時要注意什麼？</a></li>
            <li><a href="#act3">三、變數作用範圍的影響？</a></li>
            <li><a href="#act4">四、RWD 能改變同一變數的值嗎？</a></li>
            <li><a href="#act5">五、結合 calc 做加減乘除</a></li>
