...
<div class="text-content">
    ...
    <div class="text-block" id="act2">
        <h2>二、集中式狀態管理</h2>
        <p>雖然前面提過狀態管理庫採用的是集中式狀態管理，不過狀態管理實際上可分為兩種形式，分別是「分散式」狀態管理以及「集中式」狀態管理，在集中式狀態管理出現之前，狀態管理的形式基本處於分散式的管理方式，這是因為每個組件都有自己的狀態，且都只為自己的狀態負責，單就局部來看，組件各自管理自己的狀態似乎沒有什麼不妥，因為我們如果需要查找或修改某個狀態，只需要在該組件文件裡頭作業就好。</p>
        <p>分散式狀態管理示意圖：</p>
