<template>
    <NuxtLayout name="workshop">
        <TempArticle :propValue="19" fileType="workshop" />
<!-- start -->
<div class="text-content">
    ...
    <div class="text-block" id="act1">
        ...
        <div class="text-codepen">
            <p class="codepen" data-height="480" data-default-tab="result" data-slug-hash="gOZgNJE" data-user="itrong" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
            <span>See the Pen <a href="https://codepen.io/itrong/pen/gOZgNJE">
            JS effects: passward show or hide</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
&lt;/div&gt;</code></pre>
    ...
    if (input.attr("type") == "password") {
        ...
        <p>效果演示：</p>
        <div class="text-codepen">
            <p class="codepen" data-height="480" data-default-tab="result" data-slug-hash="xxmRjLM" data-user="itrong" style="height: 300px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
